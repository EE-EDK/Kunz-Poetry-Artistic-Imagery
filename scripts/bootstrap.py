...
FILE_MAP = [
    ...
    ("01-a-tree-through-the-forest-voice.wav", "01-a-tree-through-the-forest", "audio/elevenlabs"),
    ("01_A_Tree_Through_the_Forest_FINAL.mp4", "01-a-tree-through-the-forest", "video"),
    ("01-a-tree-through-the-forest-final.mp4", "01-a-tree-through-the-forest", "video"),
    ("Murdered-Mind-voice.mp3", "02-murdered-mind", "audio/elevenlabs"),
    ("02-murdered-mind-voice.mp3", "02-murdered-mind", "audio/elevenlabs"),
    ("Murdered-Mind-music.wav", "02-murdered-mind", "audio/music"),
    ("02-murdered-mind-music.wav", "02-murdered-mind", "audio/music"),
